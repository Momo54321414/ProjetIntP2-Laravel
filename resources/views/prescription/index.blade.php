                ...
                @else
                    @foreach ($prescriptions as $prescription)
                        <div class=" w-full max-w-md flex flex-col">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="cursor-pointer">
                                        ...
                                        <x-hrefbutton :href="route('prescriptions.show', [$prescription->id])">
                                            <div class="text-black dark:text-gray-200 text-lg font-bold">
                                                {{ $prescription->nameOfPrescription }}</div>
                                        </x-hrefbutton>
                                    </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="text-gray-500 hover:text-gray-300 cursor-pointer">
                                        <button x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'delete-prescription-modal-{{ $prescription->id }}')">
                            ...
                            <div class="text-gray-500 font-bold"> {{ __('MedicationName') }}
                        ...
                        <div class="flex items-center gap-4">
                            @if (!$prescriptions->isEmpty())
                                <x-modal id="delete-prescription-modal-{{ $prescription->id }}"
                                    name="delete-prescription-modal-{{ $prescription->id }}" focusable>
                                    <div class="p-6">
                                        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
