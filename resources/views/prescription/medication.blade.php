          ...
          <div class=" w-full max-w-md flex flex-col">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                <div class="text-md font-bold">{{$prescription->name}}</div>
              </div>
              <div class="flex items-center space-x-4">
                  <div>
                    100mg
                ...
                <div class="text-gray-500 hover:text-gray-300 cursor-pointer">
                    <button x-on:click="$dispatch('open-modal','edit-prescription-modal', {id: {{$prescription->id}}})">
                ...
                <div class="text-gray-500 hover:text-gray-300 cursor-pointer">
                <button x-on:click="$dispatch('open-modal','delete-prescription-modal', {id: {{$prescription->id}}})">
