...
<div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
   ...
   <ol>
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white"><b>{{__('Doc_Header_Introduction')}}</b></h3>
         <ul>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white"><b>{{__('Doc_Header_Features')}}</b></h3>
         <ul>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white"><b>{{__('Doc_Header_Setup_Process')}}</b></h3>
         <ol>
            <li>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{__('Doc_Header_Usage_Instructions')}}</h3>
         <ul>
            <li>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{__('Doc_Header_Configuration')}}</h3>
         <ul>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{__('Doc_Header_Troubleshooting')}}</h3>
         <ul>
      ...
      <li>
         <h3 class="text-xl font-semibold text-gray-900 dark:text-white">{{__('Doc_Header_Maintenance')}}</h3>
         <ul>
