...
class PrescriptionRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'frequencyBetweenDosesInHours.min' => __('P_FBDIH.min',[],$this->getLocale()),
            'frequencyBetweenDosesInHours.max' => __('P_FBDIH.max',[],$this->getLocale()),
            ...
            'frequencyOfIntakeInDays.max' => __('P_FOIID.max',[],$this->getLocale()),
